...
{
    public class Times : CaterPillar_Base
    {
        ...
        /// </summary>
        public Times()
          : base("Units of Time Conversion", "Times", "Scales a Time value from a source unit to a target unit", "Maths", "Units")
        {
            SetMenuBoxes(new string[] { "SI", "Common" });
        }
        ...
        protected List<Unit> GetUnitType(int index)
        {
            ...
            {
                default:
                    units = GetUnits(typeof(Caterpillar.Times.SI));
                    break;
                case "Common":
                    units = GetUnits(typeof(Caterpillar.Times.Common));
                    break;
            }
            return units;
        }
        ...
        protected override System.Drawing.Bitmap Icon
        {
            get
            {
                ...
                return Properties.Resources.Time24;
            }
        }
        ...
        {
            get { return new Guid("123b5bcc-7765-4af9-b22c-eb6216c39257"); }
        }
    }
}